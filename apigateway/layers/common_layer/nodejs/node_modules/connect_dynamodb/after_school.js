...
module.exports = {
  ...
  put: async (after_school_id, name, number, open_types, children) => {
    return await core.put({
      PK: '#METADATA#AFTER_SCHOOL',
      SK: 'AFTER_SCHOOL#' +  after_school_id,
      Name: name,
      Number: number,
      Config: {
        OpenTypes: open_types
      },
      Children: children,
    })
  },
  post: async (after_school_id, name, number, open_types, children) => {
