...
module.exports = {
  get_item: async (after_school_id, date) => {
    return await core.query('PK = :p_key AND SK = :s_key', {
  ...
  put: async (after_school_id, date, open_type, childlen, disability, medical_care, open_instructor, close_instructor, details, instructor_check) => {
